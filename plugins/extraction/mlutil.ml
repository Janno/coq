...
| MLchar c1, MLchar c2 -> Char.equal c1 c2
...
| (MLrel _|MLapp _|MLlam _|MLletin _|MLglob _|MLcons _
  ...
  | MLmagic _| MLuint _| MLfloat _| MLchar _| MLstring _| MLparray _), _
  -> false
...
let ast_iter_rel f =
  let rec iter n = function
    ...
    | MLuint _ | MLfloat _ | MLchar _ | MLstring _ -> ()
  in iter 0
...
let ast_map f = function
  ...
  | MLuint _ | MLfloat _ | MLchar _ | MLstring _ as a -> a
...
let nb_occur_match =
  let rec nb k = function
    ...
    | MLglob _ | MLexn _ | MLdummy _ | MLaxiom _
    | MLuint _ | MLfloat _ | MLchar _ | MLstring _ -> 0
  in nb 1
...
let dump_unused_vars a =
  let rec ren env a = match a with
    ...
    | MLglob _ | MLexn _ | MLdummy _ | MLaxiom _
    | MLuint _ | MLfloat _ | MLchar _ | MLstring _ -> a
